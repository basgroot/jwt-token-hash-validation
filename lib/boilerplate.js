...
function demonstrationHelper(settings) {
    ...
    const configSim = {
        ...
        "authUrl": "https://auth-sim.logonvalidation.net/am/oauth2/realms/root/realms/dca/authorize",
    ...
    const configLive = {
        ...
        "authUrl": "https://auth.logonvalidation.net/am/oauth2/realms/root/realms/dca/authorize",
        "redirectUrl": window.location.protocol + "//" + window.location.host + "/openapi-samples-js/assets/html/redirect.html",
        "apiHost": "gateway.saxobank.com",
        "apiPath": "/openapi",
    ...
    const configDte231 = {
        ...
        "authUrl": "https://auth-tst231.cf.saxo/am/json/realms/root/realms/dca/authenticate",
        "redirectUrl": window.location.protocol + "//" + window.location.host + "/openapi-samples-js/assets/html/redirect.html",
    ...
    const configDte211 = {
        ...
        "authUrl": "https://auth-tst211.cf.saxo/am/json/realms/root/realms/dca/authenticate",
        "redirectUrl": window.location.protocol + "//" + window.location.host + "/openapi-samples-js/assets/html/redirect.html",
                        ...
                        try {
                            ...
                            case "1":  // Response of GET /users/{UserKey}
                                ...
                                if (!responseJson.MarketDataViaOpenApiTermsAccepted) {
                                    ...
                                    console.error("User didn't accept the terms for market data via the OpenApi (Users.MarketDataViaOpenApiTermsAccepted). This is required for instrument prices on Live.");
                                }
                                break;
    ...
    function setupDemo() {
        ...
        if (tokenInputFieldExists() && Boolean(window.URLSearchParams)) {
            ...
            if (settings.hasOwnProperty("tokenValidateButton")) {
